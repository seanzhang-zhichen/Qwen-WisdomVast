...
_WELCOME_MSG = '''\
Welcome to use Qwen-WisdomVast model, type text to start chat, type :h to show command help.
(欢迎使用 Qwen-WisdomVast 模型，输入内容即可进行对话，:h 显示命令帮助。)
...
def main():
    parser = argparse.ArgumentParser(
        description='Qwen-WisdomVast command-line interactive chat demo.')
